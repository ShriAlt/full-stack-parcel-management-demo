...
<div class="payment-page">
 <div class="topbar">
  <div class="brand">parcelX Payments</div>
    ...
    <div class="form-row">
     ...
     <div class="form-group">
      ...
      <div class="cvv-wrapper">
       ...
       <button type="button" class="eye-btn" (click)="showCvv = !showCvv">{{ showCvv ? 'Hide' : 'Show' }}</button>
      </div>
