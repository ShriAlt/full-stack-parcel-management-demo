 ...
 template: `
  <main class="landing-page">
   <nav class="landing-nav">
    <div class="brand-mark">parcelX</div>
   ...
   <section class="hero">
    <div class="hero-copy">
     <p class="eyebrow">Parcel management made simple</p>
     <h1>Welcome to <span class="brand-accent">parcelX</span></h1>
     <p class="hero-text">
    ...
    <div class="hero-panel" aria-label="parcelX shipment overview">
   ...
   <footer class="landing-footer">
    ...
    <p class="footer-copy">&copy; 2026 parcelX. All rights reserved.</p>
   </footer>
  </main>
 `,
 styles: [`
