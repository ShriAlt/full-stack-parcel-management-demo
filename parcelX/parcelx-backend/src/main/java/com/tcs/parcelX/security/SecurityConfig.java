    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/parcels/admin/**").hasAnyRole("ADMIN", "DELIVERY_AGENT")
                .requestMatchers("/api/feedback/admin/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/parcels").hasRole("CUSTOMER")
                ...
                .requestMatchers(HttpMethod.GET, "/api/parcels/track/**").hasAnyRole("ADMIN", "CUSTOMER", "DELIVERY_AGENT")
                .requestMatchers(HttpMethod.GET, "/api/parcels/**").hasAnyRole("ADMIN", "CUSTOMER", "DELIVERY_AGENT")
                .requestMatchers("/api/users/profile").hasAnyRole("ADMIN", "CUSTOMER", "DELIVERY_AGENT")
