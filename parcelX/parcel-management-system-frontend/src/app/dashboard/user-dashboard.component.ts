...
<div class="dashboard-container">
 <nav class="navbar"><div class="nav-brand">Parecel Management Syatem</div><div class="nav-right"><span>{{ username }}</span><button class="logout-btn" (click)="logout()">Logout</button></div></nav>
 ...
 <footer class="footer"><p>&copy; 2026 Parecel Management Syatem. All rights reserved.</p></footer>
</div>`,
...
export class UserDashboardComponent implements OnInit {
 ...
 ngOnInit() {
  ...
  if (history.state?.loginAcknowledgement) this.showPopup('Welcome to Parecel Management Syatem', `Logged in successfully as ${this.username}.`);
